...
The [BiometricManager](https://developer.android.com/reference/androidx/biometric/BiometricManager.html#constants_1) class provides a centralised mechanism for querying the availability of biometric authentication on the device.
...
```
## BiometricPrompt Usage [BiometricPrompt](https://developer.android.com/reference/android/hardware/biometrics/BiometricPrompt)
