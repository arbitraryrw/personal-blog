...
#### Androidx Biometric Project Dependency
To add the androidx biometric library to an application simply reference it in the project's dependencies in the `app/build.gradle` file, as seen below:
...
#### Required Permission In Android Manifest
