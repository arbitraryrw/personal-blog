import naviLogo from './imgs/navi-logo.svg'
...
7_checkFuncBasicBlocksGraph.png
...
8_encodeFuncBasicBlocksGraph.png
...
10_encodeFuncRegisterValueConvert.png
...
13_checkFuncBreakpointFirstLoop.png
...
14_checkFuncBreakpointSecondLoop.png
...
17_extractingEncodedAnswer.png
...
19_scriptedDecodeAnswer.png

Once this process has been completed against all of the questions to get all of the answers, concatenate all of the answers to construct the flag  `r2con2019{yneverbothuseriouswhatlightthetorchiguessiopenitturntheknobWITHAKEYIUSEAKEY}`.

20_allAnswers.png

The server does indeed accept the answer.

21_submitFlagToR2Ctf.png
